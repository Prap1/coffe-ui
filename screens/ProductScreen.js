      ...
      <View className={`space-y-3 ${ios? 'mb-6': 'mb-3'}`}>
          <View className="flex-row justify-between items-center px-4 mb-2">
              <View className="flex-row items-center  space-x-1">
                <Text className="text-base mt-10 text-gray-700 font-semibold opacity-60">
                  Volume 
                </Text>
                <Text className="text-base mt-10 text-black font-semibold"> {item.volume}</Text>
              </View>
              <View 
                className="flex-row mt-8  items-center space-x-4 border-gray-500 border rounded-full p-1 px-4">
                <TouchableOpacity>
          ...
          {/* buy now button */}
          <View className="flex-row mt-9 justify-between px-4">
